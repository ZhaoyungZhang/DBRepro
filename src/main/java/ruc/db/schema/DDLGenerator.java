...
public class DDLGenerator implements Callable<Integer> {
    ...
    public void importData() throws IOException {
        ...
        for (Map.Entry<String, Table> tableName2Schema : TableManager.getInstance().getSchemas().entrySet()) {
            ...
            String inData = "\\Copy " + tableName.split("\\.")[1] + " FROM PROGRAM" + "'" + "cat ./data/public." + tableName.split("\\.")[1] + "-0-*" + "' DELIMITER '" + DataExportConstants.FIELD_DELIMITER + "' " + "NULL '\\N';\n";
    ...
    public void createIndex() throws IOException {
        ...
        for (Map.Entry<String, Table> tableName2Schema : TableManager.getInstance().getSchemas().entrySet()) {
            ...
            List<String> pks = new ArrayList<>(table.getPrimaryKeys());
